...
import { Play, Trophy, Settings, HelpCircle, Users, Zap, Swords, LogIn, LogOut, Shield, User, Lock, X, MessageCircle, UserPlus, Brain } from 'lucide-react';
      ...
      <div className="relative z-10 flex flex-col items-center px-4">
        ...
        >
          <img 
            ...
            alt="Corona" 
            className="w-28 h-28 object-contain drop-shadow-[0_0_20px_rgba(245,158,11,0.6)]"
          />
        </motion.div>
        ...
        <motion.h1
          ...
          style={{ 
            color: '#FEF3C7',
            textShadow: '0 0 30px rgba(245,158,11,0.5), 0 4px 8px rgba(0,0,0,0.5)',
          }}
        >
          La Senda del Saber
        </motion.h1>
        <motion.p
          ...
          className="text-lg text-amber-200 mb-8 tracking-wider"
          style={{ textShadow: '0 2px 4px rgba(0,0,0,0.5)' }}
        >
          Edicion Divina
        </motion.p>

        {/* Floating Brain/Mind Icon */}
        <motion.div
          initial={{ x: -50, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ delay: 0.6, type: 'spring' }}
          className="absolute -left-2 top-28"
        >
          <motion.div
            className="w-20 h-20 rounded-2xl bg-gradient-to-br from-indigo-500/30 to-purple-500/30 border border-white/20 flex items-center justify-center backdrop-blur-sm"
          ...
          <motion.div
            className="absolute -bottom-1 left-1/2 -translate-x-1/2 text-[10px] text-indigo-300/70 font-medium whitespace-nowrap"
        ...
        <div className="flex flex-col gap-3 w-72">
          ...
          >
            ...
            Desafios
            {!isAuthenticated && (
              <span className="absolute -top-1 -right-1 bg-white/20 rounded-full p-0.5">
