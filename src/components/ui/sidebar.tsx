...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-5 w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        ...
        {...(typeof tooltip === "string" ? { children: tooltipContent } : tooltip)}
      />
    </Tooltip>
  )
})
